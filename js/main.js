document.addEventListener('DOMContentLoaded', () => {
  ...
  if (servicesList) {
    const services = [
      { title: 'Architecture', desc: 'Concept development, architectural plans, elevations, visualization, space planning, and permit-ready documentation designed around your goals and the realities of construction.', img: '/assets/img/Architecture-home.jpg', href: '/services/architecture.html' },
      { title: 'Civil Engineering', desc: 'Site civil engineering coordinated from the beginning to improve constructability, reduce conflicts, and support municipal approval.', img: '/assets/img/Civil Engineering-option2-home.jpg', href: '/services/civil-engineering.html' },
      { title: 'Structural Engineering', desc: 'Structural design and analysis for new construction, additions, and renovations, coordinated with architecture from the earliest stage of a project.', img: '/assets/img/structural-engineering-home.jpg', href: '/services/structural-engineering.html' },
      { title: 'MEP Systems', desc: 'Mechanical, electrical, and plumbing systems designed for performance, code compliance, energy efficiency, and coordination with the architectural vision.', img: '/assets/img/mep-home.jpg', href: '/services/mep-systems.html' },
      { title: 'Professional Surveying', desc: 'Boundary, topographic, and construction surveying to establish accurate site data before design and confirm placement throughout construction.', img: '/assets/img/professional-surveying-home.jpg', href: '/services/professional-surveying.html' },
      { title: 'Construction', desc: 'Hands-on project management, subcontractor coordination, scheduling, quality control, inspections, and closeout from foundation through final completion.', img: '/assets/img/construction-home.jpg', href: '/services/construction.html' },
      { title: 'Consultation', desc: 'Independent guidance on feasibility, budget, scope, and project strategy for owners who need expert input before committing to a full design-build engagement.', img: '/assets/img/consultation-home.jpg', href: '/services/consultation.html' },
    ];
