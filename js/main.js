document.addEventListener('DOMContentLoaded', () => {
  ...
  if (servicesList) {
    const services = [
      ...
      { title: 'MEP Engineering', desc: 'Mechanical, electrical, and plumbing systems designed for performance, code compliance, energy efficiency, and coordination with the architectural vision.', img: '/assets/img/mep-home.jpg', href: '/services/mep-systems.html' },
