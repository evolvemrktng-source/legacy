document.addEventListener('DOMContentLoaded', () => {
  ...
  if (servicesList) {
    const services = [
      ...
      { title: 'MEP Engineering', desc: 'Mechanical, electrical, and plumbing systems designed for performance, code compliance, energy efficiency, and coordination with the architectural vision.', img: '/assets/img/mep-piping.jpg', href: '/services/mep-systems.html' },
      { title: 'Surveying', desc: 'Boundary, topographic, and construction surveying to establish accurate site data before design and confirm placement throughout construction.', img: '/assets/img/professional-surveying-home.jpg', href: '/services/professional-surveying.html' },
      ...
      { title: 'Consulting', desc: 'Independent guidance on feasibility, budget, scope, and project strategy for owners who need expert input before committing to a full design-build engagement.', img: '/assets/img/consultation-home.jpg', href: '/services/consultation.html' },
    ];
